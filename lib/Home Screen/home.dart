    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          icon: const Icon(Icons.menu), // Menu icon on the left side
        ),
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              title: Text('Home'),
              onTap: () {
                // Handle navigation or action when Home is clicked
            ...
            ListTile(
              ...
              title: Text('Search'),
              onTap: () {
                // Handle navigation or action when Search is clicked
                Navigator.pop(context);
              },
            ),
            ListTile(
              ...
              title: Text('Profile'),
              onTap: () {
                // Handle navigation or action when Profile is clicked
                Navigator.pop(context);
              },
            ),
